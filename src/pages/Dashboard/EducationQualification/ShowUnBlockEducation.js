...
const ShowUnBlockEducation = () => {
  ...
  const preload = async () => {
    const data = await axios.get(
      `${API}/filterUser?limit=10&skip=0&isBlocked=0`
  ...
  return (
    <div>
      <DataTable
        title="Education Qualification Table"
        columns={colunms}
...
export default ShowUnBlockEducation;
